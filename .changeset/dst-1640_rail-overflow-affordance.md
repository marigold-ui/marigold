...
- The footer takes the `ui-scroll-seam-*` top hairline the single-column sidebar's footer already had, fading out as the list bottoms out. The rail's list and its footer are siblings, so the seam resolves the list's named scroll timeline directly.
