...
github: https://github.com/marigold-ui/marigold/blob/main/packages/components/src/Dialog/Dialog.tsx
edit: https://github.com/marigold-ui/marigold/blob/main/docs/src/pages/components/dialog.mdx
switchTheme: true
...
```tsx preview file=components/Dialog/dialog-dismiss.demo.tsx
...
```tsx preview file=components/Menu/menu-open-dialog.demo.tsx
