...
In addition to the components, you usually want to install an existing [theme](/introduction/03-theming).

💬 Please note that [react](https://www.npmjs.com/package/react) >= 17.0.0 and [react-dom](https://www.npmjs.com/package/react-dom) >= 17.0.0 are peer dependencies for `@marigold/components`.
