...
- **Filter Bar:** Sits above the data set with the search field and the button that opens the filter panel. Built as a layout composition with [Inline](/components/layout/inline).
...
{/_ TODO(DST-1511): Relative date-range presets are composed in userland today.
PR #5631 adds them to the design system. Once it lands, update this section
and the filter-date-presets demo to use the built-in presets. _/}
