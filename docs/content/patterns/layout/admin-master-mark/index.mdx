...
For boolean fields, such as [Checkbox](/components/form/checkbox#badge), [Radio](/components/form/radio#badge) and [Switch](/components/form/switch#badge), pass the badge to their `badge` slot rather than building it into the label yourself. The slot sizes the badge to the label's line, keeping the control centred on it instead of drifting above it.
