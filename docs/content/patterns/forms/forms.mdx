...
- "Back" or "Previous" in multi-step forms belongs **above** the form, not next to submit. Placing them side by side leads to accidental clicks because people lose track of which button goes which direction.
...
<GuidelineTiles>
  <Do>
    <Do.Description>
      <ul>
        <li>
          Use clear visual hierarchy: one primary (filled) button, secondary
          actions use the secondary variant.
        </li>
        <li>
          Keep the primary button position consistent across all form pages.
        </li>
        <li>Place the primary action first (leftmost) in the button row.</li>
        <li>
          Only use one primary-styled button per form. Multiple primary buttons
          make it unclear what the main action is.
        </li>
      </ul>
    </Do.Description>
  </Do>
