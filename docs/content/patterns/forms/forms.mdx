...
<Table aria-label="spacing tokens">
  ...
  <Table.Body>
    ...
    <Table.Row key={2}>
      ...
      <Table.Cell>Used for creating vertical space between individual form fields.</Table.Cell>
      <Table.Cell>`<Stack>`</Table.Cell>
    </Table.Row>
    <Table.Row key={3}>
      <Table.Cell>`fieldX`</Table.Cell>
      <Table.Cell>1.25rem (20px)</Table.Cell>
      <Table.Cell>Used for creating horizontal space between individual form fields.</Table.Cell>
