...
Proper spacing between fields creates a clear visual hierarchy and improves form readability. Use the token `field-Y` for vertical spacing between individual fields within a section, and the token `field-X` for horizontal spacing between fields that are positioned on the same line.
...
<Table aria-label="spacing tokens">
  ...
  <Table.Body>
    ...
    <Table.Row key={2}>
      ...
      <Table.Cell>
        Used for creating vertical space between individual form fields.
      </Table.Cell>
      <Table.Cell>`<Stack>`</Table.Cell>
    </Table.Row>
    <Table.Row key={3}>
      ...
      <Table.Cell>
        Used for creating horizontal space between individual form fields.
      </Table.Cell>
      ...
      <Table.Cell>
        Used for grouping related fields together, such as address components or date and time fields.
      </Table.Cell>
