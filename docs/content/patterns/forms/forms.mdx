...
Spacing between fields uses the following tokens:

- **`regular`**: Default vertical spacing between fields. Use `<Stack space="regular">` within any section or group.
- **`related`**: For two fields that form a logical unit, such as start/end dates or postcode + city. Use `<Stack space="related">` for related pairs.
...
<ComponentDemo file="./form-spacing-field.demo.tsx" />
