...
Use the `<Stack>` component to stack elements and separate them with a fix spacing.
Alter the horizontal alignment of the children elements inside of their parent with the `align` prop.
