...
However, how you use Marigold also affects the accessibility of a product. Read this page to learn about accessibility in general and check the component pages for additional accessibility guidelines to help ensure your product is usable by everyone.
...
<p id="section-description">Update your username, email, and password here.</p>
...
<ComponentDemo file="./accessibility-keyboard.demo.tsx" disableLabelWidth />
...
<ComponentDemo file="./accessibility-focus.demo.tsx" disableLabelWidth />
