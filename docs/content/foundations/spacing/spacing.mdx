  ...
  <Table.Body>
    ...
    <Table.Row>
      ...
      <Table.Cell>
        ...
        or paired form fields forming a unit (e.g. Start Date + End Date,
        Postal Code + City).
      </Table.Cell>
      <Table.Cell>
        <Text fontStyle='italic' color="text-primary-muted">Label + Input, Icon + Text, Headline + Subhead, paired form fields, ...</Text>
      </Table.Cell>
    </Table.Row>
    <Table.Row>
