...
<Table aria-label="Relational scale explanation">
  <Table.Header>
  ...
  <Table.Body>
    <Table.Row>
      ...
      <Table.Cell>
        <Text fontStyle='italic' color="text-primary-muted">Data table rows, multi-line card metadata, Headline + Description, ...</Text>
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>**Related**</Table.Cell>
      <Table.Cell>
        The small gap communicates that two distinct elements form a
        single conceptual pair or unit. Use it for elements that belong
        together but are each self-contained, such as paired form fields
        (e.g. Start Date + End Date, Postal Code + City) or an icon
        next to a text label.
      </Table.Cell>
      <Table.Cell>
        <Text fontStyle='italic' color="text-primary-muted">Paired form fields, Icon + Text, Headline + Subhead, ...</Text>
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      ...
      <Table.Cell>
        ...
        elements standing as equals within the same content flow. This is
        the baseline rhythm for form fields and the page's standard reading
        rhythm.
      </Table.Cell>
      <Table.Cell><Text fontStyle='italic' color="text-primary-muted">Baseline form field spacing, list items, paragraphs, ...</Text></Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>**Group**</Table.Cell>
      <Table.Cell>
        A substantial gap that visually clusters related elements into a
        sub-group within a larger context. It separates a block of content
        from its surroundings, signaling that the enclosed elements belong
        together as a logical unit.
      </Table.Cell>
      <Table.Cell>
        <Text fontStyle='italic' color="text-primary-muted">Cards in a grid, address block within a form, content clusters in a sidebar, ...</Text>
      </Table.Cell>
    </Table.Row>
    <Table.Row>
...
<Table aria-label="Relational token types" stretch>
  <Table.Header>
    <Table.Column>**Token Typ**</Table.Column>
    <Table.Column>**CSS Variable**</Table.Column>
  </Table.Header>
  <Table.Body>
    <Table.Row>
      <Table.Cell>Relational</Table.Cell>
      <Table.Cell><div className="*:text-xs!">`--spacing-<relational scale>`</div></Table.Cell>
    </Table.Row>
  </Table.Body>
</Table>
...
<ComponentDemo file="./spacing-grouping.demo.tsx" mode="preview" />
...
<Table aria-label="Inset scale explanation">
  <Table.Header>
    <Table.Column>**Token**</Table.Column>
    <Table.Column>Description</Table.Column>
    <Table.Column width="1/5">Common Patterns</Table.Column>
...
<Table aria-label="Inset token types" stretch>
  <Table.Header>
    <Table.Column>**Token Typ**</Table.Column>
    <Table.Column>**CSS Variable**</Table.Column>
  </Table.Header>
  <Table.Body>
    <Table.Row>
      ...
      <Table.Cell><div className="*:text-xs!">`--spacing-square-<inset scale>`</div></Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>Squish</Table.Cell>
      <Table.Cell><div className="*:text-xs!">`--spacing-squish-<inset scale>`</div></Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>Stretch</Table.Cell>
      <Table.Cell><div className="*:text-xs!">`--spacing-stretch-<inset scale>`</div></Table.Cell>
    </Table.Row>
  </Table.Body>
</Table>
