...
Spatial relationships are self contained. A specific spacing token, such as "group", retains its semantic meaning regardless of where it appears in the hierarchy. You do not need to arbitrarily increase spacing values just because an element is higher up in the page structure.

### Recursion in Practice

This approach creates a recursive system where the same tokens can be reused effectively at multiple levels of nesting:
