...
<ComponentDemo name="surface-sunken" />
...
<ComponentDemo name="surface-default" />
...
<ComponentDemo name="surface-raised" />
...
<ComponentDemo name="surface-overlay" />
...
<Tabs items={['B2B', 'CORE']} defaultIndex={0}>
  <Tab value="B2B">
    <ImageZoom
      width={700}
      height={450}
