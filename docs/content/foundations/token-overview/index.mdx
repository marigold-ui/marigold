  ...
  tokens={[
    {
      ...
      value: 'charcoal-100',
      useFor:
        'Quiet selection wash for list items (SelectList, ListBox, Sidebar), paired with one ink mark: the row indicator in option lists, the inset-shadow-selection stroke in navigation',
    },
    {
      name: 'selected-bold',
      value: 'charcoal-900',
