...
<TokenTable
  tokens={[
    ...
    },
    {
      ...
      useFor:
        'Structural lines drawn on a known surface, such as dividers, table row and grid lines, section rules, and internal separators. Opaque so crossing strokes cannot stack. Lightness and chroma are tuned by eye; the hue is derived from the palette',
    },
    {
      name: 'ring',
      value: 'charcoal-600',
