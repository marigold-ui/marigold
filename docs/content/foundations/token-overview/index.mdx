...
<TokenTable
  tokens={[
    ...
    },
    {
      ...
      useFor:
        'Visible boundary of a control (inputs, selects, the secondary Button), applied via ui-control. The denser sibling of surface-border, kept above the contrast threshold so the edge stays visible',
    },
  ]}
/>
