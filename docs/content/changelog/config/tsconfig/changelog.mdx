...
_[View the full changelog on Github](https://github.com/marigold-ui/marigold/blob/main/config/tsconfig/CHANGELOG.md)_

## 0.4.0 (Released on Mon Jan 09 2023)
...
## 0.3.1 (Released on Fri Dec 09 2022)
