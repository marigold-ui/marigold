...
This is the biggest single release we've shipped, and it is the first step in a longer effort, not the last. The design language is evolving to feel more mature, read more clearly, and fit the real complexity of the product surfaces we support. Expect more token work and more refinements across the next few minor releases. v18 is the foundation you'll build on. It is not the destination.
