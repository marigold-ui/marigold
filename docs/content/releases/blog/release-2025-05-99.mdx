...
A new drawer components has been added. There is no documentation yet because it isstill in beta. You can take a look at the drawer components in Storybook (https://marigold-latest.vercel.app/?path=%2Fstory%2Fcomponents-drawer--basic&globals=theme%3Arui).
