...
A new drawer components has been added. There is no documentation yet because it isstill in beta. The component will be used in the upcoming filter pattern.
...
The drawer component ist only available in the RUI theme. If you would like to use the drawer components, let us know and we can help you.
