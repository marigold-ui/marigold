...
- **Focus Fixes:** We've addressed an issue where the focus ring-3 wasn't displaying correctly for `<Checkbox>`, ensuring that it now shows up properly when used in a table context.
