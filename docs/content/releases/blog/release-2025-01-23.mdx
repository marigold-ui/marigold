...
Happy New Year! 🥳 Marigold v10.1.2 kicks off the year with updates to key components, bug fixes, and the introduction of a brand-new component. Thanks for being part of the journey—we’re excited for what’s ahead.
