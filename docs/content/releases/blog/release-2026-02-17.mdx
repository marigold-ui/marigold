...
The `<FileField>` component now supports a `name` prop, making it straightforward to include file uploads in standard HTML forms. See the [FileField documentation](/components/form/file-field) for details.
