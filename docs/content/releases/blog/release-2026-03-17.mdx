...
The [form patterns](/patterns/forms) have been updated to use the new tokens, showing how `section`, `group`, `regular`, and `related` work together to create clear visual hierarchy in real forms -- from major section breaks down to paired fields like postal code and city.
