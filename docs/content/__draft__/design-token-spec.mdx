...
2. **Context:** Identifies different use cases for a token. For example, to indicate user feedback or visual hierachy.
...
- variant or context? primary or brand?
