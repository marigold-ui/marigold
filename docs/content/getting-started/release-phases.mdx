...
| Phase      | Purpose                                   | Audience        | Docs                          | Stability     |
| ---------- | ----------------------------------------- | --------------- | ----------------------------- | ------------- |
| **Alpha**  | Internal validation, feasibility          | Select partners | None or minimal               | Unstable      |
| **Beta**   | Public testing, feedback-driven iteration | Early adopters  | Full docs, limitations listed | Mostly stable |
| **Stable** | Production-ready release                  | All users       | Final docs                    | Stable        |

---

### Phase Comparison

| Stage      | Ready for Production? | Public Docs? | Breaking Changes Expected?      | Feedback Actively Sought? | Badge(s) in Docs |
| ---------- | --------------------- | ------------ | ------------------------------- | ------------------------- | ---------------- |
| **Alpha**  | ❌ No                 | ❌ No        | ✅ Yes                          | ✅ Yes (internal)         | alpha            |
| **Beta**   | ⚠️ Limited            | ✅ Yes       | ⚠️ Possible                     | ✅ Yes                    | beta             |
| **Stable** | ✅ Yes                | ✅ Yes       | ❌ No (with deprecation policy) | ✅ Ongoing                | new              |
