...
<SectionMessage variant="info">
  <SectionMessage.Title>View the tokens</SectionMessage.Title>
...
- **masterMark:** Used in our Core System to show specific permissions only RX employees can use.
- **adminMark:** Used in our Core System for permissons only developer can see.
