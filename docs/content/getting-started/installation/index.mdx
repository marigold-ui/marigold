...
<Callout title="Prefer an automated setup?">
  The [Marigold CLI](/getting-started/cli) can do the steps below for you. Run
  [`marigold init`](/getting-started/cli#marigold-init) in an existing Next.js
  or Vite project to install the packages, patch your CSS and config, and wrap
  the root with `MarigoldProvider`.
</Callout>
