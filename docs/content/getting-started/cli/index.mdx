...
Diagnose why Marigold isn't working in a project. Reads the filesystem only (no network) and prints a checklist with actionable fixes, ideal when components render unstyled or throw, and for AI agents to self-diagnose and repair a setup.
