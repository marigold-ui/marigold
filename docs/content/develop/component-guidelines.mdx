...
This codeblock show how to apply `classNames` on the `<Input>` component which has diffrent slots. It can be styled through theme are: icon, action and input.
