...
”What can I use as a guide when I have a request for the design system team?”. Here is the answer.

We created a framework which we and our stakeholders can use as a guide to become more confident in dealing with the design system. The process of how we handle changes and additions is written down in the page [Governance process](/introduction/governance-process).
