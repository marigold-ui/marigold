...
We have been asked these questions many times by our stakeholders and they have motivated us to find ways to provide more transparency. One tool to achieve this goal is to develop values and principles to guide us and our stakeholders in how the design system team makes decisions and prioritises.

The result is an operating framework which we and our stakeholders can use as a guide to become more confident in dealing with the design system. The process of how we handle changes and additions is written down in the page Governance process.
