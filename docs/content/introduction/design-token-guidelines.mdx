...
<SectionMessage messageTitle="View the tokens" variant="info">
...
<SectionMessage messageTitle="Icon Color" variant="info">
...
<SectionMessage messageTitle="Not mandatory" variant="info">
