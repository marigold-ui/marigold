...
If you have a question which regards more explaination, you should ask for a meeting in the Channel or the Design System PO (@Katharina Ochmann). It’s easier for us to understand your current problem better. It’s better for us to gather enough time and focus on your problem.
...
_(Remember even if it’s just 20 min, its better than 30+ slack messages)_

## Design Related Questions:

Ask your Area Designer, if you are the Area Designer please contact the UX/UI CoP or write in [#design-system](https://reservix.slack.com/archives/C02727BNZ3J).

## Feature requests:

If you need a certain component or feature in your application, which is currently not in Marigold please contact the Design System PO (@Katharina Ochmann) or even better write us a feature request in our [Support Board](https://reservix.atlassian.net/servicedesk/customer/portal/77). We take care of your request.
...
If you notice something broke or doesn’t work as before, please write us a [Bug Ticket in Jira](https://reservix.atlassian.net/servicedesk/customer/portal/77). We will have a look on it and prioritize this case.
