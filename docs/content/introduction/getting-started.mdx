...
Selecting a theme will help you effortlessly apply a specific look and feel to the Marigold components so that they fit your context. To add a theme, install it `@marigold/components` package.
