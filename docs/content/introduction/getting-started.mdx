...
Please make sure that you have a `postcss.config.js` file with following content in your project:
...
This is installing Tailwind CSS as a PostCSS plugin, for a easy setup.
