...
[View tokens as JSON](https://jsonhero.io/j/DZZeE10Xr6a7)
...
Shadow tokens are used to apply specific shadow to an element. They are equivalent to the `box-shadow` CSS rule or the [shadow utilities](https://tailwindcss.com/docs/outline-color) in TailwindCSS.
...
Radius tokens adhere to T-shirt size conventions, with designations such as lg (large), md (medium), and so on.
