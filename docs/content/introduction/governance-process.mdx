...
This phase is only relevant if the product team has written a [Jira Support Ticket (internal only)](https://reservix.atlassian.net/servicedesk/customer/portal/77). The process starts when a support ticket is received.
