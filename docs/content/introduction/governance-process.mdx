...
When you ask yourself: What about bugs? They probably wouldn't go through these same steps and would face different evaluation criteria. To read more about how to report bugs go [here](/introduction//get-in-touch/#report-bugs).
