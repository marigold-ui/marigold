...
This phase is only relevant if you have written a [Jira Support Ticket (internal only)](https://reservix.atlassian.net/servicedesk/customer/portal/77). This phase explains what happens to your request and how we evaluate it.
