...
| `master`      | Menu item with a lock glyph in the master access color. | Actions reserved for Reservix employees (master access).       |
| `admin`       | Menu item with a key glyph in the admin access color.   | Actions reserved for developers (admin access).                |
