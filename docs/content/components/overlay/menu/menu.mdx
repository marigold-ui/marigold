...
- **Separator input:** Graphic device to separate a section of similar menu items. If there is more than one section, a separator is not needed in the first section.

- **Section header:** Contains a heading to name a section of a group of similar menu items.

- **Menu items:** Represent an individual option or action within a Menu component.
