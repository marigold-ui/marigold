...
## Alternative Components
    ...
    •	[SectionMessage](/content/section-message): Use to highlight important information inline that should remain visible as users read or interact with the page.
