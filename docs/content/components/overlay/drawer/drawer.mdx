...
<ComponentDemo file="./drawer-secondary-details.demo.tsx" />
...
<ComponentDemo file="./drawer-edit-flow.demo.tsx" />
...
<ComponentDemo file="./drawer-contextual-utility.demo.tsx" />
...
- left: navigaiton, or menus.
- top: lightweight global actions like notifications or system alerts.
- bottom: confirmation actions, or quick picks.
