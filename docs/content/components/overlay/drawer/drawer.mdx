...
While drawer component is open, users can still interact with the rest of the page. To accomodate both mouse and keyboard usersm the `<Drawer>` provide multiple ways to close it:
