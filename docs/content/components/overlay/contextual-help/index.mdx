...
import { ContextualHelpAnatomy } from './contextual-help-anatomy';
...
<AppearanceDemo component={'ContextualHelp'} />
...
<ComponentDemo name="contextual-help-label" />

### Description

Use `<ContextualHelp.Description>` for a short summary directly below the title, while the content carries the detailed explanation.

<ComponentDemo name="contextual-help-description" />
...
<ComponentDemo name="contextual-help-placement" />
...
<ComponentDemo name="contextual-help-interactive" />

## Props

<StorybookHintMessage component={'ContextualHelp'} />

### ContextualHelp

<AutoTypeTable path="ContextualHelp" name="ContextualHelpProps" />

### ContextualHelp.Title

<AutoTypeTable
  path="ContextualHelp/ContextualHelpTitle"
  name="ContextualHelpTitleProps"
/>

### ContextualHelp.Description

<AutoTypeTable
  path="ContextualHelp/ContextualHelpDescription"
  name="ContextualHelpDescriptionProps"
/>

### ContextualHelp.Content

<AutoTypeTable
  path="ContextualHelp/ContextualHelpContent"
  name="ContextualHelpContentProps"
/>
