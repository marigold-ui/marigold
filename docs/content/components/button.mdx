...
<FigmaLink
  to={
    'https://www.figma.com/file/DFKyTGHAoDxOsUBPszLLxP/%F0%9F%8F%B5%EF%B8%8FMarigold?node-id=11%3A269'
  }
/>
...
| :-------------------- | :-------------------------------------- | :------ |
| `variant` (optional)  | `primary`, `secondary`, `ghost`, `text` | `none`  |
...
```tsx
<Button variant="primary" size="small" space="xxsmall">
  <Ticket /> Primary
</Button>
```
