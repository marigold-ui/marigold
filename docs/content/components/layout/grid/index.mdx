---
title: Grid
description: Arrange elements in a grid structure.
---
...
Below you find an example demonstrating how to create the [holy grail layout](<https://en.wikipedia.org/wiki/Holy_grail_(web_design)>) using the `<Grid>` component below. It is useful if you need easy vertical and horizontal alignment of content while staying responsive.

<ComponentDemo name="grid-holy-grail" />

### Bento

The `<Grid>` component can also be used to create [bento layouts](https://bootcamp.uxdesign.cc/web-design-trend-bento-box-95814d99ac62). Here is an example for a more complex grid, where every element has its own dimensions.

<ComponentDemo name="grid-bento" />

## Props

<StorybookHintMessage component={'Grid'} />

### Grid

<AutoTypeTable path="Grid" name="GridProps" />

### Grid.Area

<AutoTypeTable path="Grid/GridArea" name="GridAreaProps" />
...
<ul>
  <li>[Tiles](/components/layout/tiles): With `<Tiles>` you have the possibility to create equal wide elements in a grid system.</li>
  <li>[Columns](/components/layout/columns): If you need to have elements placed in one line.</li>
</ul>
