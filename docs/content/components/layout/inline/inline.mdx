...
When aligning form inputs with buttons , use `alignToInputBaseline={true}` to mantain vertically alignment with the input field rectangle. This automatically adjusts when descriptions or error messages appear.
