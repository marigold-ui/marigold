...
Most Danger zones hold one action. Put it in the Footer, with a short paragraph in the Content explaining what disappears. Lead with the consequence, not the verb. The Footer is only for actions scoped to this Panel; page-level **Save changes** and **Cancel** stay outside.
