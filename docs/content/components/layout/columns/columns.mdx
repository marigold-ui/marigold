...
In this example the columns are filled with interactive elements. This is a good use case for a column component. Unlike in tables you can use the interactive elements without loosing the accessibility features.

<ComponentDemo file="./table-layout-columns.demo.tsx" />

### Columns collapsing at a certain width

You can also add space between the columns und set a `collapseAt` prop to collapse the columns at a certain width. This is convenient for a good responsivness.
...
With columns you also have the possibility to create a whole page layout
