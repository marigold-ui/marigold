  ...
  props={[
    {
      ...
      description:
        'An array of numbers to set the size of the children. The columns array length and the count of children must be the same. Write "fit" for the column you want to have it fitting the contents width.',
      type: '(number| "fit")[]',
      default: 'none',
    },
    {
