...
By using the `stretch` prop you can make the container to take full height. Note that this is usually not necessary since the columns will expand with their children anyway.
