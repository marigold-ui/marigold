...
The `<Tiles>` is a layout component which is based on [CSS grid](https://www.w3schools.com/css/css_grid.asp) system. With the grid you have the possibility to create equal wide `<Tiles>`.
