...
<SectionMessage>
  ...
  <SectionMessage.Content>The width of the `<Container>` is not fixed but adjusts based on the font size. This is because the optimal reading length is determined by the number of characters per line.</SectionMessage.Content>
</SectionMessage>
