...
To use the split with the inline correctly you have to set the inline as parent and add the split between the two elements you want to separate.
...
<ComponentDemo name="split-inline" />
...
<ComponentDemo name="split-stack" />
...
<TeaserList
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 17.25 12 21m0 0-3.75-3.75M12 21V3" />
    ...
    },
    {
      title: 'Inline',
      href: '../layout/inline',
      caption: 'Align elements horizontally in a row.',
      icon: (
       <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
