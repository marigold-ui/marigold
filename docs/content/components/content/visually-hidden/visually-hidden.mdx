...
You should use a visually hidden component like `<VisuallyHidden>` when you want to make information available to screen reader users without displaying it visually on the screen.
...
<StorybookHintMessage component={'visually-hidden'} />
