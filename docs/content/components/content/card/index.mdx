...
According to our [elevation guidelines](/foundations/elevation#raised), the card should be placed on the default page background (`bg-background`).
...
<GuidelineTiles>
  <Do>
    <DoDescription>
      Use Card on top of the default page background.
    </DoDescription>
  </Do>
  <Dont>
    <DontDescription>
