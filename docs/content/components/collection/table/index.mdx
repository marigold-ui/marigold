...
| `admin`   | Highlights rows relevant to admin users. [Learn more.](/patterns/admin-master-mark)  | Marking content that is only visible or relevant to admin users.                   |
| `master`  | Highlights rows relevant to master users. [Learn more.](/patterns/admin-master-mark) | Marking content that is only visible or relevant to master users.                  |
