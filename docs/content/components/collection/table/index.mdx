...
For long, scrollable tables, make the footer sticky so the summary stays visible while users scroll through the rows, mirroring how sticky headers keep column labels in view.
