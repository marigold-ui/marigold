...
Proper alignment makes data easier to scan and compare. Different data types benefit from different alignments.
...
Users can triple-click or drag to select text within cells.
