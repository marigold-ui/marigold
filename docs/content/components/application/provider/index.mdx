...
description: Container for apps using Marigold.
---
...
<ComponentDemo name="provider-root-styles" />
...
<StorybookHintMessage component={'MarigoldProvider'} />

### MarigoldProvider

<AutoTypeTable path="Provider/MarigoldProvider" name="MarigoldProviderProps" />
