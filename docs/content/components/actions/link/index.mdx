...
| `master`    | Link with a lock glyph in the master access color.                             | Inline actions reserved for Reservix employees (master access).                                     |
| `admin`     | Link with a key glyph in the admin access color.                               | Inline actions reserved for developers (admin access).                                              |
