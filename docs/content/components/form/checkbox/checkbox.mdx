...
Checkboxes are used when there are a multiple items to select in a list.
Each checkbox works independently from other checkboxes in the list, therefore checking an aditional box does not affect any other selections.
