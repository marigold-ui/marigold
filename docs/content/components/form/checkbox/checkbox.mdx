...
Checkboxes allow user to to toggle a single option or to select multiple options from a list. Each checkbox works independently, so selecting one does not affect the others. Users can choose none, one, or many items.
