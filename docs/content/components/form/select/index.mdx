...
- **Chevron:** Visual cue that the field opens a list.
...
- **Section:** Optional grouping with a header that helps users scan related options.
- **Option:** A single choice in the list.
- **Selection indicator:** Marks the option that is currently selected.
