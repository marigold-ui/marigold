...
### Item description - Primary and Secondary Content

If you need to have secondary content shown within an item, you can use the `description` property on the option to write a short description.
