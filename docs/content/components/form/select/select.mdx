...
If there are very few options (e.g., 1-4), consider using radio buttons instead. These can be easier for users to scan and select.
...
When there are too many options (e.g., more than 15-20), usability can suffer. Users might find it cumbersome to scroll through a long list. In such cases, consider alternative approaches like a combobox or autocomplete.
  ...
  <Do>
    <Do.Figure>
      <Image
        ...
        height={700}
        unoptimized
        src="/select/select-do-short.jpg"
        alt="Use a radio group for 1-4 options"
      />
    </Do.Figure>
    <Do.Description>
      If there are 1-4 options to choose from, use a [radio
      group](../form/radio).
    </Do.Description>
  </Do>
  <Dont>
    <Dont.Figure>
      <Image
        ...
        height={700}
        unoptimized
        src="/select/select-dont-short.jpg"
        alt="Dont use less than three options"
      />
    </Dont.Figure>
    <Dont.Description>
      Don't use a select if there are less than 4 options to choose from.
    </Dont.Description>
  </Dont>
</GuidelineTiles>
  ...
  <Do>
    <Do.Figure>
      <Image
        ...
        height={700}
        unoptimized
        src="/select/select-do-long.jpg"
        alt="Use a radio group for 1-4 options"
      />
    </Do.Figure>
    <Do.Description>
      If there are 15-20 options to choose from, its recommended to use a
      [autocomplete](../form/autocomplete) or [combobox](../form/combobox).
    </Do.Description>
  </Do>
  <Dont>
    <Dont.Figure>
      <Image
        ...
        height={700}
        unoptimized
        src="/select/select-dont-long.jpg"
        alt="Dont use less than three options"
      />
    </Dont.Figure>
    <Dont.Description>
      Don't use a select if there are more than 15 options to choose from.
    </Dont.Description>
  </Dont>
</GuidelineTiles>
