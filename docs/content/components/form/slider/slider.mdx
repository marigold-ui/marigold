...
The label is automatically places on the right spot of the slider and inform users what value(s) they have selected. You can place it with the `label` prop.
