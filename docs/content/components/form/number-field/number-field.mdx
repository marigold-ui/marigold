...
<ComponentDemo
  file="./number-field-stepper.demo.tsx"
...
<ul>
  <li>
    [NumericFormat](/components/formatters/numericformat): Helper component for
    formatting numeric based on the current language and locale-specific
    conventions. Mainly used outside a form.
  </li>
</ul>
