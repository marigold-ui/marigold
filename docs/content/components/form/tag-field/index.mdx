---
title: TagField
description: A multi-select field that displays selected items as removable tags with a searchable dropdown.
badge: beta
---

import { TagFieldAnatomy } from './tag-field-anatomy';
...
<AppearanceDemo component={'TagField'} />

<AppearanceTable component={'TagField'} />
...
<ComponentDemo name="tag-field-section" />
...
<ComponentDemo name="tag-field-disabled-items" />
...
<StorybookHintMessage component={'TagField'} />

### TagField

<AutoTypeTable path="TagField" name="TagFieldProps" />
...
- [SelectList](/components/form/selectlist): When you need more than just a text label to represent options and want a persistent, visible list.
