...
<ul>
  ...
  <li>
    <b>Container:</b> The container area that displays selected tags and the
    button.
  </li>
  <li>
  ...
  <li>
    <b>Button:</b> An icon button that opens the dropdown popover to add more
    selections.
  </li>
  <li>
  ...
  <li>
    <b>Section:</b> A group of related options with a header label, used to
