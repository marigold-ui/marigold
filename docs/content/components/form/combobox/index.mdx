...
<ComponentDemo name="combobox-description" />
...
The ComboBox component supports working with asynchronous data. In the example below, the [`useAsyncListData`](/components/hooks-and-utils/useAsyncListData) hook is used to handle the loading and filtering of data from the server.
