...
<Callout title="Deprecated" type="warn">
  The Multiselect component is now deprecated. Please use the new TagField
  component instead, which provides better accessibility, keyboard navigation,
  and is built on react-aria.
</Callout>
...
<AppearanceDemo component={'Multiselect'} />

<AppearanceTable component={'Multiselect'} />

## Usage

<Callout title="Keyboard Navigation Issues" type="warning">
  ...
  temporarily confuse users. Note: This accessibility limitation stems from the
  react-select library's implementation
</Callout>
...
<GuidelineTiles>
  <Dont>
    <DontDescription>
      Avoid using MultiSelect when users need to pick a single option, the list
      is small, space isn't an issue or search isn't necessary.
    </DontDescription>
  </Dont>
</GuidelineTiles>
...
<ComponentDemo name="multiselect-controlled" />

## Props

<StorybookHintMessage component={'Multiselect'} />

<AutoTypeTable path="Multiselect" name="MultipleSelectProps" />
