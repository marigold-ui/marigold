...
<SectionMessage variant="warning">
  <SectionMessage.Title>Deprecated Component</SectionMessage.Title>
  <SectionMessage.Content>
    The Multiselect component is now deprecated. Please use the new
    [TagField](/components/form/tag-field) component instead, which provides
    better accessibility, keyboard navigation, and is built on react-aria.
  </SectionMessage.Content>
</SectionMessage>
