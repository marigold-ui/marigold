...
<SectionMessage variant="warning">
  ...
  <SectionMessage.Content>
    The Multiselect component has some notable accessibility issues with
    keyboard navigation. As shown in the video, the focus indicator gets hidden
    by the disabled state, which stops the expected behavior of skipping
    disabled options. This can cause users to get briefly confused due to the
    lack of clear visual feedback.
  </SectionMessage.Content>
</SectionMessage>
