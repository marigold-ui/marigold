...
<SectionMessage>
  ...
  <SectionMessage.Content>
    The `<FieldGroup>` is a component for the layout of the label and the field itself. You can use `labelWidth`, which
    is
    a string type, to specify the width of the label. It's needed only when using the <strong>core</strong> theme.
  </SectionMessage.Content>
</SectionMessage>
