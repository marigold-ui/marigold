...
import { BreadcrumbsAnatomy } from './breadcrumbs-anatomy';
...
- **Breadcrumbs item:** A single step of the navigation path, linking to that level.
- **Separator:** The chevron between two items, marking the hierarchy.
