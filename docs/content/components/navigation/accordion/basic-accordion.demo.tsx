  ...
  return (
    <Accordion defaultExpandedKeys={[1]}>
      <Accordion.Item id={1} key={1}>
        <Accordion.Header title="Harry Potter and the Philosopher's Stone" />
        <Accordion.Content>
          {' '}
          <Text>
      ...
      <Accordion.Item id={2} key={2}>
        <Accordion.Header title="Harry Potter and the Chamber of Secrets" />
        <Accordion.Content>
          <Text>
            ...
            School of Witchcraft and Wizardry, during which a series of messages
            on the walls of the school's corridors warn that the "Chamber of
            Secrets" has been opened and that the "heir of Slytherin" would kill
            all pupils who do not come from all-magical families. These threats
            are found after attacks that leave residents of the school
            petrified. Throughout the year, Harry and his friends Ron and
            Hermione investigate the attacks.
          </Text>
        </Accordion.Content>
      </Accordion.Item>
      <Accordion.Item id={3} key={3}>
        <Accordion.Header title="Harry Potter and the Prisoner of Azkaban" />
        <Accordion.Content>
          <Text>
            Harry Potter and the Prisoner of Azkaban is a fantasy novel written
            by British author J. K. Rowling and is the third in the Harry Potter
            series. The book follows Harry Potter, a young wizard, in his third
            year at Hogwarts School of Witchcraft and Wizardry. Along with
            friends Ronald Weasley and Hermione Granger, Harry investigates
            Sirius Black, an escaped prisoner from Azkaban, the wizard prison,
