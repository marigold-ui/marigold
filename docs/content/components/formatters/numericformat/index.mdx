...
<ComponentDemo name="numericformat-common-format" />
...
<ComponentDemo name="numericformat-range-format" />
...
<ComponentDemo name="numericformat-tabular-format" />
...
<ComponentDemo name="numericformat-numbering-system-format" />
...
<AutoTypeTable
  package="system"
  path="Formatters/NumericFormat"
  name="NumericFormatProps"
/>
...
<TeaserList
  items={[
    {
      title: 'NumberField',
      href: '/components/form/number-field',
      caption: 'Component for entering numeric values in forms.',
      icon: (
        <svg
