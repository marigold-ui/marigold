...
const typography = {
  ...
  pre: ({ className, ...props }: HTMLAttributes<HTMLPreElement>) => (
    <pre
      className={cn(
        'not-prose **:data-line:leading-[22px] *:bg-transparent *:p-0',
        'px-(--pre-padding-x) max-h-[650px] rounded-lg py-4',
  ...
  code: (props: HTMLAttributes<HTMLElement>) => (
    <code
      className="my-0 inline-grid rounded-sm bg-black/5 px-1 py-0.5 font-mono text-sm before:content-none after:content-none"
      {...props}
    />
  ),
};
