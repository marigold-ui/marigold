...
- 8a0dc28: docs(DST-1707): disclose the AI-generated demo imagery

  The demo portraits, venue photos and illustrative filler images in the docs are AI-generated and depict fictional people, venues and events. The legal notice now says so in both its German and its English section, and the two demo data modules carry the same note so it travels with the code. `contributing.md` records the convention for new assets: no new photorealistic synthetic people or places, prefer illustration or diagram or abstract artwork, and label a photorealistic AI image if one is genuinely needed.

  No images were changed.

  [DST-1707](https://reservix.atlassian.net/browse/DST-1707)

- 7da0efe: fix(DST-1753): stop docs pages formatting numbers with the runtime locale
...
- 841f5e8: chore(deps): port the prop-table transform to fumadocs-typescript 5.4.0
...
- 30ecf9d: docs(DST-1719): document the single-thumb form of the Slider `thumbLabels` prop
...
- 6497037: docs(DST-1687): document the data-entry grid pattern
  ...
  Extends the table record management pattern from three options to four with the
  data-entry grid — a `<Table>` of always-on form controls with
  `keyboardNavigationBehavior="tab"` — and restructures the Table component page's
  editing guidance into `Editing`, covering editable cells and the grid side by side.
