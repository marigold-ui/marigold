...
To extend a theme with customized styles use the `extendsTheme` function as like this:
...
Afterwards you can use the customzed like you would do with any other styles from themes. Meaning, `<Button variant="cta">Buy now</Button>` will render our custom CTA button like shown below:
