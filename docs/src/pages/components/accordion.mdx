...
<PropsTable
  props={[
    ...
    },
    {
      ...
      type: 'boolean',
      description:
        'Sets the width to fullsize per default. If not wanted change to false.',
      default: 'true',
    },
    {
      property: 'textValue',
...
In this example you can see how an `<Accordion>` would look like with stretch property set to false.
