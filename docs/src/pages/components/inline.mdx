...
The `<Inline>` is a responsive layout component. It's inline element with space between each element. This component uses the spaces from the given theme or a responsive string.
