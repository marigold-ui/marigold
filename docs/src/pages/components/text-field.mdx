...
<PropsTable
  props={[
    ...
    },
    {
      property: 'side',
      type: '"right" | "left"',
      description: 'Set the label on the right or left side.',
      default: 'none%',
    },
    {
      property: '...',
...
The Example shows how to use the `side` property. With that you can decide on which side you want your `label`.

```tsx preview file=components/TextField/textfield-side.demo.tsx
