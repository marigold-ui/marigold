...
// image: Some atomic layouts

<svg
  role="img"
  width="200"
  height="100"
  aria-labelledby="stack layout"
  viewBox="0 0 200 100"
>
  <rect x="0" y="0" rx="10" ry="10" width="200" height="25" />
  <rect x="0" y="35" rx="10" ry="10" width="200" height="25" />
  <rect x="0" y="75" rx="10" ry="10" width="200" height="25" />
</svg>
