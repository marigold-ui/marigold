...
As mentioned before, Marigold uses a certain format to define the appearancesce of components. It consists of the `base`, `variant` and `size` (see [Component Styles](#component-styles)). The most basic API for styling a component looks like this:
...
```
    ...
    TODO: how styling is applied via hook etc.
