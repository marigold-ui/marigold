...
- _Variants:_ a collection of styles for each Marigold components
...
Writing component styles in a maintainable way, especially when over the life of a growing and changing project is a challenging task.
