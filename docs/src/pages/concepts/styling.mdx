...
TODO: -> hint how to easily style component based on the theme.

The full breakdown of how theming a component works can be found in the "[Theming Components](#theming-components)" section down below.
