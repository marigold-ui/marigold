...
_'Have a look on the latest changes regarding @marigold/theme-rui'_

## 4.0.2 (Released on <DateFormat value={new Date("Thu Dec 04 2025 09:22:30 GMT+0100 (Central European Standard Time)")} dateStyle="medium" />)
...
## 4.0.1 (Released on <DateFormat value={new Date("Wed Nov 26 2025 13:58:38 GMT+0100 (Central European Standard Time)")} dateStyle="medium" />)
