...
_Learn about the structure and application of our design tokens_
...
> ℹ️ Icon Color: Text color tokens can also be employed to colorize icons since they all have
...
> ℹ️ Not mandatory: The relevance of height is limited to specific components. In numerous
