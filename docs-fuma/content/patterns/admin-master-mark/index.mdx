...
<ComponentPreview name="admin-master-mark-anatomy" mode="preview" />
...
<ComponentPreview name="admin-master-mark-placement" />
...
<ComponentPreview name="admin-master-mark-table" />
