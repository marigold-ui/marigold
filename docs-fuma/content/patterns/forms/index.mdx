...
<ComponentPreview name="form-section" />
...
<ComponentPreview name="form-spacing-fields" />
...
<ComponentPreview name="form-accordion" />
...
<Table aria-label="spacing tokens">
  <TableHeader>
    ...
    <TableColumn>Relevant components</TableColumn>
  </TableHeader>
  <TableBody>
    <Table.Row key={0}>
      <TableCell>`container`</TableCell>
      <TableCell>50rem (800px)</TableCell>
      <TableCell>Used width or max-width for the form container.</TableCell>
      <TableCell>`<div>`, `<Form>`</TableCell>
    </Table.Row>
    <Table.Row key={1}>
      <TableCell>`section`</TableCell>
      <TableCell>3.5rem (56px)</TableCell>
      <TableCell>Used for creating space between different form sections.</TableCell>
      <TableCell>`<Stack>`</TableCell>
    </Table.Row>
    <Table.Row key={2}>
      <TableCell>`fieldY`</TableCell>
      <TableCell>2rem (32px)</TableCell>
      <TableCell>Used for creating vertical space between individual form fields in a section.</TableCell>
      <TableCell>`<Stack>`</TableCell>
    </Table.Row>
    <Table.Row key={3}>
      <TableCell>`fieldX`</TableCell>
      <TableCell>1.25rem (20px)</TableCell>
      <TableCell>Used for creating horizontal space between individual form fields in a section.</TableCell>
      <TableCell>`<Inline>`</TableCell>
    </Table.Row>
      <Table.Row key={4}>
      <TableCell>`group`</TableCell>
      <TableCell>1rem (16px)</TableCell>
      <TableCell>Used for grouping related fields (address components, date/time fields) or multiple accordion sections together.</TableCell>
      <TableCell>`<Stack>`, `<Inset>`</TableCell>
    </Table.Row>
  </TableBody>
</Table>
...
<ComponentPreview file="form-link" mode="preview" />
...
<ComponentPreview file="form-action" mode="preview" />
