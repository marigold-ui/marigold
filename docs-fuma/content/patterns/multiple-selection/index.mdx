...
<ComponentDemo name="multiselect-checkbox-group" />
...
<ComponentDemo name="multiselect-basic" />
...
<ComponentDemo name="tag-group-multiselect" />
...
<ComponentDemo name="multiple-selection-selectlist" />
