...
<ComponentPreview name="table-layout-columns" />
...
<ComponentPreview name="layout-columns" />
...
<ComponentPreview name="fit-width-columns" />
...
<ComponentPreview name="stretch-columns" />
...
<ComponentPreview name="stretch-columns-switch" />
