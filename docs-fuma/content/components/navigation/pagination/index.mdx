---
title: Pagination
description: Component that divides up large datasets into manageable chunks.
---
...
<AppearanceDemo component={'Pagination'} />

<AppearanceTable component={'Pagination'} />
...
<ComponentPreview name="pagination-no-data" />
