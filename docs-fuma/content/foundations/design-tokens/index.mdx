...
<Tabs>
  <TabsList>
    <TabsItem id="fontSize">Font Size</TabsItem>
    <TabsItem id="fontWeight">Font Weight</TabsItem>
    <TabsItem id="fontStyle">Font Style</TabsItem>
    <TabsItem id="textAlign">Text Align</TabsItem>
  </TabsList>
  <TabsTabPanel id="fontSize">
    <FontSizes />
  </TabsTabPanel>
  <TabsTabPanel id="fontWeight">
    <FontWeights />
  </TabsTabPanel>
  <TabsTabPanel id="fontStyle">
    <FontStyle />
  </TabsTabPanel>
  <TabsTabPanel id="textAlign">
    <TextAlign />
  </TabsTabPanel>
</Tabs>
...
<Tabs>
  <TabsList>
    <TabsItem id="alignX">Horizontal</TabsItem>
    <TabsItem id="alignY">Vertical</TabsItem>
  </TabsList>
  <TabsTabPanel id="alignX">
    <AlignmentsX />
  </TabsTabPanel>
  <TabsTabPanel id="alignY">
    <AlignmentsY />
  </TabsTabPanel>
</Tabs>
