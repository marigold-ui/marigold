...
**What it is: <Badge style={{ marginLeft: 6, verticalAlign: 'middle' }}>alpha</Badge>**
...
**What it is <Badge style={{ marginLeft: 6, verticalAlign: 'middle' }}>beta</Badge>:**
...
**What it is stable <Badge style={{ marginLeft: 6, verticalAlign: 'middle' }}>new</Badge>: **
