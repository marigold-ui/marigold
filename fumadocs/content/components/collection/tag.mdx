---
title: Tag
description: Used to manage related options.
---
...
<AppearanceDemo component={'Tag'} />

<AppearanceTable component={'Tag'} />
...
<ComponentDemo name="tag-selection" />
...
<ComponentDemo name="tag-removable" />
...
<ComponentDemo name="tag-remove-all" />

## Props

<StorybookHintMessage component={'Tag'} />

### Tag

<AutoTypeTable path="TagGroup/Tag" name="TagProps" />

### Tag.Group

<AutoTypeTable path="TagGroup/TagGroup" name="TagGroupProps" />
