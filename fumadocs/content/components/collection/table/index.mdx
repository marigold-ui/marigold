...
<Callout title="What is tabular data?">
...
<GuidelineTiles>
  <Do>
    ...
    <DoDescription>Stretch tables to available width.</DoDescription>
  </Do>
  <Dont>
    <DontFigure>
      <ImageZoom
    ...
    <DontDescription>Don't use a table for layouting content.</DontDescription>
  </Dont>
</GuidelineTiles>
...
<Callout title="Hint: Dynamic Collections">
