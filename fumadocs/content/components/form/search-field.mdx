...
<GuidelineTiles>
  <Do>
    ...
    <DoDescription>Position the search field prominently.</DoDescription>
  </Do>
  <Dont>
    <DontFigure>
      <ImageZoom
...
<StorybookHintMessage component={'SearchField'} />

### SearchField

<AutoTypeTable path="SearchField/SearchField.tsx" name="SearchFieldProps" />
