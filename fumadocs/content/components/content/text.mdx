---
title: Text
description: Component for displaying text paragraphs
---
...
<AppearanceDemo component={'Text'} />

<AppearanceTable component={'Text'} />
...
<ComponentDemo name="text-color" />

## Props

<StorybookHintMessage component={'Text'} />

### Text

<AutoTypeTable path="Text/Text.tsx" name="TextProps" />
