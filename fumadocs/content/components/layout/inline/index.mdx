...
<ComponentDemo name="inline-elements" />
...
<ComponentDemo name="inline-vertically" />

For horizontally alignment you can use the `alignX` prop.

<ComponentDemo name="inline-horizontally" />
...
<ComponentDemo name="inline-input-button" />
...
<ComponentDemo name="inline-nowrap" />

## Props

<StorybookHintMessage component={'Inline'} />

### Inline

<AutoTypeTable path="Inline" name="InlineProps" />
