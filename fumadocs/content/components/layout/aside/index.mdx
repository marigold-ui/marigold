---
title: Aside
description: Component to seperate content from the main content.
---
...
<ComponentDemo name="aside" />

## Props

<StorybookHintMessage component={'Aside'} />

### Aside

<AutoTypeTable path="Aside" name="AsideProps" />
