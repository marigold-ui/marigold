...
<Callout title="Note">
  Setting the the `stretch` prop is usually not necessary since the columns will
  expand with their children anyway.
</Callout>
...
<StorybookHintMessage component={'Columns'} />

### Columns

<AutoTypeTable path="Columns" name="ColumnsProps" />
