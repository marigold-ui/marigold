...
The `<RouterProvider>` component is re-exported from `react-aria-components` and accepts the same props. For detailed prop information, please refer to the [React Aria documentation](https://react-spectrum.adobe.com/react-aria/routing.html).
