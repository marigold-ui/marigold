...
It is useful if you want to have a list in which you can select more items. It combines checkboxes with a list view, which lets it differ from the other examples above.
