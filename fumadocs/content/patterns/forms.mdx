...
<ComponentDemo name="form-section" />
...
<ComponentDemo name="form-spacing-fields" />
...
<ComponentDemo name="form-accordion" />
...
<table aria-label="spacing tokens">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>0.5rem (8px)</td>
      <td>
        Used for grouping related fields (address components, date/time fields)
        or multiple accordion sections together.
      </td>
      <td>
...
<ComponentDemo name="form-link" mode="preview" />
...
<ComponentDemo name="form-action" mode="preview" />
