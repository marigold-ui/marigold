...
github: https://github.com/marigold-ui/marigold/blob/main/packages/components/src/Checkbox/Checkbox.tsx
edit: https://github.com/marigold-ui/marigold/blob/main/docs/src/pages/components/checkbox.mdx
group: Forms
switchTheme: true
...
```tsx preview file=components/Checkbox/checkbox-indeterminate.demo.tsx
