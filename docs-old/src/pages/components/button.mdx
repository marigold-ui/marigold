  ...
  props={[
    {
      ...
      description: 'Spacing between child element.',
      default: 'none',
    },
    {
      property: 'onPress',
...
```tsx preview file=components/Button/button-primary.demo.tsx
...
```tsx preview file=components/Button/button-secondary.demo.tsx
...
```tsx preview file=components/Button/button-ghost.demo.tsx
...
```tsx preview file=components/Button/button-text.demo.tsx
...
```tsx preview file=components/Button/button-link.demo.tsx
