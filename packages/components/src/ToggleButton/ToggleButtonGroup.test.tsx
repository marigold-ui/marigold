...
test('renders correctly with children', () => {
  ...
  expect(screen.getByRole('radiogroup')).toMatchInlineSnapshot(`
    <div
      ...
      class="group inline-flex ui-control shadow-elevation-border text-sm"
