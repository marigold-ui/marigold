...
With the Image component you can render a `img` element.
The themeSection ist `content` and variant can be added with the variant prop which is `images` per default.
