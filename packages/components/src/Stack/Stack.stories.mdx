...
import { Button, Heading, Stack, Text } from '@marigold/components';
import { Box } from '../Box';
...
Layout component to stack elements.

## Properties

| Property | Type                                      | Default |
| :------- | :---------------------------------------- | :------ |
| `space`  | `0, 4, 8, 16, 24, 32, 40, 48, 56, 64, 88` | `0`     |
...
<Canvas>
  <Story name="Example 1">
    <Stack space={24} className={useStyles({ bg: '#f3f3f3' })}>
