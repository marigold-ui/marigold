...
describe('style usage', () => {
  ...
  test('usage with <Box>', () => {
    const Button = ({ children }) => {
      ...
      return React.createElement(
        Box,
        { __baseCSS: styles, 'data-testid': 'button' },
        children
      );
    };
    render(
  ...
  test('usage with <Box> (with parts)', () => {
    const Checkbox = ({ children }) => {
      ...
      return React.createElement(
        Box,
        { 'data-testid': 'container', __baseCSS: styles.container },
        React.createElement(
          Box,
          { 'data-testid': 'label', as: 'label', __baseCSS: styles.label },
          children,
          React.createElement(Box, {
            'data-testid': 'icon',
            __baseCSS: styles.icon,
          })
        )
      );
    };
    render(
      React.createElement(
        ThemeProvider,
        { theme: theme },
        React.createElement(Checkbox, null, 'Click me!')
      )
    );
...
//# sourceMappingURL=useComponentStyles.test.js.map
