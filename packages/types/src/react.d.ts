 ...
 */
export declare type ComponentProps<T extends React.ElementType> = Omit<
 ...
 * type ButtonProps = ComponentProps<'button'>
 */
export declare type ComponentPropsWithRef<T extends React.ElementType> = Omit<
  React.ComponentPropsWithRef<T>,
  'style'
>;
/**********************************************/
/**********************************************/
declare type ForwardRefComponent<P> = Pick<
 ...
 */
export declare type PropsWithAs<P, T extends React.ElementType> = P & {
  as?: T;
};
/**
 * Helper type to create props including the polymorphic `as` prop, but no `ref`.
 */
export declare type PolymorphicProps<P, T extends React.ElementType> = Merge<
  ComponentProps<T>,
  PropsWithAs<P, T>
>;
/**
 ...
 */
export declare type PolymorphicPropsWithRef<
  P,
  T extends React.ElementType
> = Merge<ComponentPropsWithRef<T>, PropsWithAs<P, T>>;
/**
