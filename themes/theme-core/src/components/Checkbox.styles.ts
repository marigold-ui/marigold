...
export const Checkbox: ThemeComponent<'Checkbox'> = {
  ...
  checkbox: cva([
    ...
    'group-[disabled]/checkbox:group-[selected]/checkbox:border-border-base-disabled group-[disabled]/checkbox:border-border-base-disabled group-[disabled]/checkbox:group-[selected]/checkbox:bg-bg-inverted-disabled-dark',
