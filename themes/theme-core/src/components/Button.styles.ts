...
export const Button: ThemeComponent<'Button'> = cva(
  [
    'border-border-base bg-bg-inverted text-text-dark ease-ease-out h-6 cursor-pointer rounded-sm border px-4 py-0 text-sm leading-[22px] transition-all duration-200 disabled:cursor-none',
