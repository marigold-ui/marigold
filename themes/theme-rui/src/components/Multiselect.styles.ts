...
export const MultiSelect: ThemeComponent<'MultiSelect'> = {
  ...
  container: cva({
    base: [
      ...
      'has-[input[data-invalid=true]]:border-destructive-accent has-[input[data-invalid=true][data-focused=true]]:!border-destructive-accent has-[input[data-invalid=true][data-focused=true]]:!outline-destructive-accent/20',
      'has-[input[data-focused=true]]:!border-ring has-[input[data-focused=true]]:!outline-ring/50 has-[input[data-focused=true]]:outline-3 has-[input[data-focused=true]]:outline-offset-0',
  ...
  option: cva({
    base: [
      ...
      'aria-disabled:text-disabled aria-disabled:cursor-not-allowed',
      '[&.isFocused:not([aria-disabled=true])]:ui-state-hover!',
    ],
  }),
