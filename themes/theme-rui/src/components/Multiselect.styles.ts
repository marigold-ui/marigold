...
export const MultiSelect: ThemeComponent<'MultiSelect'> = {
  ...
  container: cva({
    base: [
      ...
      'has-[input[data-invalid=true]]:border-destructive has-[input[data-invalid=true][data-focused=true]]:!border-destructive has-[input[data-invalid=true][data-focused=true]]:!outline-destructive/20',
